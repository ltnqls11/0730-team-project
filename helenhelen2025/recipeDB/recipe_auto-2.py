            ...
            with cols[i]:
                ...
                st.markdown(f"""
                    ...
                    ">
                        ...
                        <p style="margin: 0; font-size: 0.9em;"><strong>유통기한:</strong> {pd.to_datetime(ingredient['expiry_date']).strftime('%Y-%m-%d') if pd.notna(ingredient['expiry_date']) and ingredient['expiry_date'] else '정보 없음'}</p>
                    </div>
                """, unsafe_allow_html=True)
